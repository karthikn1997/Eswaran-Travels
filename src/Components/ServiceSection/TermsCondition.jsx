    ...
    <>
      <div className='w-full max-w-7xl mx-auto border h-auto px-5 py-6 md:px-8 lg:px-10 bg-white shadow-sm'>
        ...
        <ul className='pl-6 list-disc tracking-wider text-gray-700 space-y-3'>
          ...
          <li>
            Please co-operate with the tour operator in case of delays due to traffic or other unforeseen circumstances.
          </li>
          <li>
          ...
          <li>
            Smoking and consumption of alcohol are strictly prohibited on the vehicle.
          </li>
          <li>
