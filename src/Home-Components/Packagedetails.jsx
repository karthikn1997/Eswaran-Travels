...
const Packagedetails = () => {
  ...
  return (
    <div className="w-full mx-auto p-4 pb-10 lg:py-20 px-4 sm:px-10">
      <h2
        className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-wider text-secondary bg-gradient-to-b from-blue-400 via-blue-200 to-blue-400 py-5 lg:py-3 px-4 lg:px-8 mb-6 lg:mb-16 text-center lg:text-left lg:rounded-ss-full rounded-ss-3xl lg:rounded-ee-full rounded-ee-3xl"
          ...
          >
            <Link to={item.link}>
              ...
              <div className="px-3 sm:px-6 h-auto mt-2">
                <h3 className="text-base font-semibold flex lg:text-left text-center justify-center lg:justify-start items-center gap-5 text-primary mb-1">
                  {item.destination}
                  <span className="text-black font-semibold text-2xl mt-1">
                    {item.icon}
                  </span>
                </h3>
                <div className="flex lg:items-center lg:text-left text-center gap-2 pt-2 justify-center lg:justify-start">
                  {renderStars(item.rating)}
                  <span className="font-thin text-sm">( Top Rating )</span>
                </div>
              </div>

              <div className="p-2 px-3 sm:px-6 h-auto text-sm flex flex-col gap-2 sm:gap-4 my-2 whitespace-nowrap tracking-wide text-center lg:text-left">
                <div className="flex flex-wrap gap-1 xl:gap-3 justify-center lg:justify-start tracking-wide">
                  <span className="border px-2">1 Day</span>
                  <span className="border px-2">AC Vehicle only </span>
                  <span className="border px-2">A Complete guidance</span>
                </div>
              </div>
