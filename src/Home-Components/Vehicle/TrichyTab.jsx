...
const Vehicledetails = () => {
  ...
  const vehicleDetails = [
    { detail: "Trichy", km: "350 km", seat: "4+1", amt: "Rs.5100" },
    { detail: "Trichy", km: "350 km", seat: "6+1", amt: "Rs.6800" },
    { detail: "Trichy", km: "350 km", seat: "6+1", amt: "Rs.8200" },
    { detail: "Trichy", km: "350 km", seat: "12+1", amt: "Rs.9100" },
  ]
  return (
    <>
