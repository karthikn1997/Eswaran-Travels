...
const Vehicledetails = () => {
  ...
  const vehicleDetails = [
    { detail: "Palani", km: "270 km", seat: "4+1", amt: "Rs.4500" },
    { detail: "Palani", km: "270 km", seat: "6+1", amt: "Rs.5800" },
    { detail: "Palani", km: "270 km", seat: "6+1", amt: "Rs.7300" },
    { detail: "Palani", km: "270 km", seat: "12+1", amt: "Rs.7600" },
  ]
  return (
    <>
                ...
                <div className="w-full min-h-64 flex  xl:flex-row flex-col justify-center items-center xl:gap-10 ">
                  ...
                  >
                    ...
                    {icons1.map((iconItem, iconIndex) => (
                      <div
                        className="flex items-center gap-3 px-5 lg:px-0"
                        key={iconIndex}
                        data-aos="fade-up"
                        duration-aos-delay="300"
