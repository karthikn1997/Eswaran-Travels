  ...
  return (
    <section className="w-full  lg:px-10 px-4">
      <div className="mx-auto">
        {/* Title */}
        <h2
          className="lg:text-4xl text-3xl font-bold text-center lg:mb-6 text-secondary py-6 lg:py-8 sm:py-5 tracking-wide"
          ...
          {items.map((item, itemIndex) => (
            ...
            >
              ...
              <div className="w-[90%] flex flex-col lg:flex-row items-center justify-between gap-6 px-4 py-4 border-[1px] border-secondary rounded-lg">
                ...
                <div className="w-1/2 flex flex-col items-center lg:border-r-[1px] lg:border-secondary">
                  <h4 className="text-lg font-semibold text-center text-[#070F4E] mb-5 border-b-2 border-secondary pb-1">
                    Above 300 Km (Per day)
                  </h4>

                  {icons1.map((iconItem, iconIndex) => (
                    <div
                      className="flex items-left gap-3 text-[#070F4E] font-medium mb-3 px-4"
                      key={iconIndex}
                    >
                ...
                <div className="w-1/2 flex flex-col items-center">
                  ...
                  {icons1.map((iconItem, iconIndex) => (
                    <div
                      className="flex items-center gap-3 text-[#070F4E] font-medium mb-3 px-4"
                      key={iconIndex}
                    >
                      <span className="text-xl border p-1 rounded-full">{iconItem.icon}</span>
                      <p>
