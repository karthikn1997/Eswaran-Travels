            ...
            {items.map((item, itemIndex) => (
              ...
              >
               ...
               <img
                ...
                >
                  <button className="lg:text-lg text-base w-32 font-semibold bg-[#070F4E] text-white rounded-lg py-1 lg:mr-3 lg:mb-3 text-center">{item.description}</button>
                  ...
                  {icons1.map((iconItem, iconIndex) => (
                    ...
                    >
                      ...
                      <p
                        className="lg:text-base text-sm text-gray-600 tracking-wide font-medium"
                        data-aos="fade-left"
                        data-aos-delay="400"
                        data-aos-easing="ease-in-sine"
                        data-aos-duration="400"
