...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[70vh] w-full flex flex-col-reverse lg:flex-row items-center justify-center hero-section bg-[#070f4e] border-2 border-yellow-500 pb-8">
{/* 
      ...
      <div className='px-8 lg:p-20 flex flex-col justify-center items-center lg:items-start'>
        <h1 className="text-2xl sm:text-3xl lg:text-5xl text-white font-bold mb-4 text-center lg:text-left" data-aos="slide-right" data-aos-delay="300">
          Welcome to <span className='text-yellow-400 font-extrabold' style={{textShadow: "2px 2px black"}}>Eswaran Travels</span>
        </h1>
        ...
        <button onClick={scrollToSection} className="bg-gradient-to-r from-[#005AB3] via-gray-900 to-black hover:bg-gradient-to-l text-white font-semibold py-2 sm:py-3 px-8 rounded-xl transition duration-300 border-[1px] border-gray-800 whitespace-nowrap" data-aos="flip-left" data-aos-delay="300">
          <div className='flex items-center gap-3 font-bold text-xl text-white hover:text-black'>
            <span className='text-lg lg:text-2xl text-white'>Coming Soon</span><span className='text-2xl animate-bounce'><FaRegArrowAltCircleDown className='text-yellow-400'/></span>
          </div>
        </button>
      </div>

      <div className="relative z-10 text-center px-5 w-full lg:w-[60%] mt-4 sm:mt-10" data-aos="slide-left">
        <Slider {...settings}>
          <div>
            <img src={Hero1} className='w-full sm:w-[80%] mx-auto mt-8' alt="" />
          </div>

          <div>
            <img src={Hero2} className='w-full sm:w-[80%] mx-auto mt-8' alt="" />
          </div>

          <div>
            <img src={Hero3} className='w-full sm:w-[80%] mx-auto mt-6' alt="" />
          </div>
        </Slider>
