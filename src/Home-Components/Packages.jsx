  ...
  const gridItems = [
    {
      ...
      car: <RiPoliceCarLine />,
      title: "Madurai",
      price: "Package starting from ₹ 750",
      rating:"4.5",
      day:"1 D",
      night:" - ",
    ...
    },
    {
      ...
      car: <RiPoliceCarLine />,
      title: "Kodaikanal",
      price: "Package starting from ₹ 1300",
      rating:"4.5",
      day:"1 D",
      night:"2 D - 1 N",
      destination: "Madurai to Kodaikanal",
      link: "/secondTabVehicle",
    },
    {
      id: 3,
      icon: <PiCarProfileLight />,
      car: <RiPoliceCarLine />,
      title: "Rameshwaram",
      price: "Package starting from ₹ 1400",
      rating:"4.5",
      day:"1 D",
      night:"2 D - 1 N",
      destination: "Madurai to Rameshwaram",
      link: "/thirdTabVehicle",
    },
    {
      id: 4,
      icon: <PiCarProfileLight />,
    ...
    <div className="w-full mx-auto p-4 lg:py-20">
      ...
      >
        {gridItems.map((item) => (
          <div
            key={item.id}
            className="relative bg-white shadow-md rounded overflow-hidden border border-secondary transition-transform duration-300 hover:scale-105"
          >
            <Link to={item.link}>
              ...
              <div className=" bottom-0  w-full p-2 flex justify-between items-center px-6">
